...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("user not found ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("can not find the user with id=".concat(id, "  . Error ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("could not add user ".concat(u.firstName, " ").concat(u.lastName, " . Error ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, deluser, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        deluser = result.rows[0];
                        conn.release();
                        return [2 /*return*/, deluser];
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("could not deleted user with id ".concat(id, " Error ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    //======================To verify the user=======================
    UserStore.prototype.auth = function (firstName, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("something is wrong Error ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
